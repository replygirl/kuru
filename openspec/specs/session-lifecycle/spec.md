...
## Purpose
Define durable session identity, reversible lifecycle, settled public transcripts,
bounded fork and export, and the CLI/TUI controls that expose them without
confusing session history with shared project memory.
