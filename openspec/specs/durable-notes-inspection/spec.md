# durable-notes-inspection Specification

## Purpose
Define provider-free, bounded inspection of durable identity notes through the
runtime, CLI, and TUI while preserving namespace, revision, and identity
boundaries.
