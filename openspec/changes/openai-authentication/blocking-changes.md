...
assumption, tracked by windows-command-lock-release. Final CI closure awaits that
test correction; it does not change the native OpenAI authentication scope.
