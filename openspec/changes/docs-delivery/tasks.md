## 1. Build and delivery plumbing

- [x] 1.1 Pin current tools and dependencies, refresh lockfiles, and expose docs/release mise tasks.
- [x] 1.2 Build and validate docs in required CI; add exact-SHA Pages deployment with minimal permissions.
- [x] 1.3 Update development documentation and verify clean generation, formatting and workflow syntax.
