...
- [x] 1.3 Update canonical contributor instructions and command documentation; verify documented task names, managed drift and repository invariants.
- [x] 1.4 Run the new workflow on GitHub's native runners, record observed jobs and remaining application failures separately, validate and archive this CI change after its scheduling acceptance passes.
