...
- [x] 3.4 Observe successful aggregate CI for the verified candidate, then strictly validate and archive the completed primitive change; record the actual aggregate result without substituting the successful Windows job alone.
