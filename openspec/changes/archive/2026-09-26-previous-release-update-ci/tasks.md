...
- [x] 3.1 Update `docs/release.md`, `docs/development.md`, `AGENTS.md`, the helper comment and the resolver doc comment to describe previous-release acceptance as a floor run natively in CI on every supported platform, and verify with `docs:check`-level formatting and link checks.
