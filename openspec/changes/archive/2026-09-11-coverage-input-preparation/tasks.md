...
- [x] 1.3 Run the normal concurrent pre-push with a fresh private Dolt cache, then observe actual native CI coverage and installed-runtime checks; record cold startup and measured preparation separately from historical timings before archiving.

Final integration passed at a1547ed; verification records the actual native
results and timings separately from the retained 1943c4e cold-cache experiment.
