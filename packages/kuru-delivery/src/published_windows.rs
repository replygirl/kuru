...
use crate::{
    archive, command, mise_isolation,
    published::{METADATA_LIMIT, PublicGitHub, PublishedRelease, REPOSITORY},
    release, targets,
};
...
pub async fn run(options: Options) -> Result<()> {
    ...
    // The post-publication verifier reads anonymously.
    let github = PublicGitHub::new(None)?;
