...
The demo provider requires neither network access nor credentials. It lets you explore the interface, framework choices, memory, and session controls. Its predictable responses do not test live model access.
